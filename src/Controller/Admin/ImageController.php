...
class ImageController extends AbstractController
{
    ...
    {
        return $this->render('back_end/image/index.html.twig', [
    ...
    public function new(Request $request,$id,ImageRepository $imageRepository): Response
    {
        ...
        $images = $imageRepository->findBy(['Station'=>$id]);

        return $this->render('back_end/image/new.html.twig', [
            'image' => $image,
            'id' => $id,
            'images' => $images,
    ...
    {
        return $this->render('back_end/image/show.html.twig', [
            'image' => $image,
        ]);
    }
    ...
    public function edit(Request $request, Image $image): Response
    {
        ...
        return $this->render('back_end/image/edit.html.twig', [
            'image' => $image,
            'form' => $form->createView(),
        ]);
    }
